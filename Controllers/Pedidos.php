...
class Pedidos extends Controllers{
	...
	public function Pedidos()
	{
		...
		$data['page_title'] = "PEDIDOS <small>Sana y Sana</small>";
	...
	public function orden($idpedido){
		...
		$data['page_tag'] = "Pedido - Sana y Sana";
		$data['page_title'] = "PEDIDO <small>Sana y Sana</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - Sana y Sana";
