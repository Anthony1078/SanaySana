...
class Paginas extends Controllers{
	...
	public function paginas()
	{
		...
		$data['page_title'] = "PÁGINAS <small>Sana y Sana</small>";
	...
	public function editar($idpost){
		...
		if($idpost > 0){
			...
			$data['page_title'] = "ACTUALIZAR PÁGINA <small>Sana y Sana</small>";
	...
	public function crear(){
		...
		$data['page_title'] = "CREAR PÁGINA <small>Sana y Sana</small>";
