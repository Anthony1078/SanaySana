			 ...
			 ?>
				<div class="item-slick1" style="background-image: url(<?= $arrSlider[$i]['portada'] ?>);">
					<div class="container h-full">
						<div class="row mt-5 h-full p-t-100 p-b-30 ">
								...
								<div class="col-lg-5">
										<h2 class="ltext-201 p-t-19 p-b-43 respon1" style="color: #6c7ae0;">
											<?php 
											$texto = "";
											if($arrSlider[$i]['descripcion'] == "Jarabes"){
												$texto = "Los mejores precios en jarabes!";
											}else if($arrSlider[$i]['descripcion'] == "Pastillas"){
												$texto = "Precios incomparables en pastillas!";
											}else{
												$texto = "Encontrarás las mejores ofertas!";
											}
											echo $texto;
											?>											
										</h2>
